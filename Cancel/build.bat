...
set SOURCE=CancelReport.cs CancelReportDlg.cs

set RESOURCES=CancelReportDlg.resx

set COMPILED_RESOURCES=/res:CancelReportDlg.resources,CancelReport.CancelReportDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile CancelReportDlg.resx
