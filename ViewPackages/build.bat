...
set SOURCE=ViewPackages.cs ViewPackagesDlg.cs

set RESOURCES=ViewPackagesDlg.resx

set COMPILED_RESOURCES=/res:ViewPackagesDlg.resources,ViewPackages.ViewPackagesDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile ViewPackagesDlg.resx
csc /nologo /t:winexe %COGDLLS% /r:SamplesCommon.dll %SOURCE% %ICON% %COMPILED_RESOURCES%
