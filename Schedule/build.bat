...
set SOURCE=Schedule.cs ScheduleDlg.cs

set RESOURCES=ScheduleDlg.resx

set COMPILED_RESOURCES=/res:ScheduleDlg.resources,Schedule.ScheduleDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile ScheduleDlg.resx
