...
set SOURCE=Email.cs EmailDlg.cs EmailContactsDlg.cs

set RESOURCES=EmailDlg.resx EmailContactsDlg.resx

set COMPILED_RESOURCES=/res:EmailDlg.resources,Email.EmailDlg.resources /res:EmailContactsDlg.resources,Email.EmailContactsDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile EmailDlg.resx EmailContactsDlg.resx
