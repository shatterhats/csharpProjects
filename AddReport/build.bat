...
set SOURCE=AddReport.cs AddReportDlg.cs

set RESOURCES=AddReportDlg.resx

set COMPILED_RESOURCES=/res:AddReportDlg.resources,AddReport.AddReportDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile AddReportDlg.resx
