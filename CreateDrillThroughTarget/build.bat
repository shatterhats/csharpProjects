...
set SOURCE=CreateDrillThroughTarget.cs CreateDrillThroughTargetDlg.cs

set RESOURCES=CreateDrillThroughTarget.resx CreateDrillThroughTargetDlg.resx

set COMPILED_RESOURCES=/res:CreateDrillThroughTarget.resources,CreateDrillThroughTarget.CreateDrillThroughTarget.resources /res:CreateDrillThroughTargetDlg.resources,CreateDrillThroughTarget.CreateDrillThroughTargetDlg.resources

set COGDLLS=/r:cognosdotnet.dll /r:cognosdotnetassembly.dll /r:AxInterop.SHDocVw.dll /r:Interop.SHDocVw.dll

resgen /compile CreateDrillThroughTarget.resx CreateDrillThroughTargetDlg.resx
