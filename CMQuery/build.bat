...
set SOURCE=cmQuery.cs CMQueryDlg.cs

set RESOURCES=CMQuerytDlg.resx

set COMPILED_RESOURCES=/res:CMQueryDlg.resources,cmQuery.CMQueryDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile CMQueryDlg.resx
