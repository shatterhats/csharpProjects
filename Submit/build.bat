...
set SOURCE=Submit.cs SubmitDlg.cs

set RESOURCES=SubmitDlg.resx

set COMPILED_RESOURCES=/res:SubmitDlg.resources,Submit.SubmitDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile SubmitDlg.resx
