...
set SOURCE=ViewReports.cs ViewReportsDlg.cs

set RESOURCES=ViewReportsDlg.resx

set COMPILED_RESOURCES=/res:ViewReportsDlg.resources,ViewReports.ViewReportsDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile ViewReportsDlg.resx
