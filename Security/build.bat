...
set SOURCE=Security.cs SecurityDlg.cs

set RESOURCES=SecurityDlg.resx

set COMPILED_RESOURCES=/res:SecurityDlg.resources,Security.SecurityDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile SecurityDlg.resx
