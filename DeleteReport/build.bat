...
set SOURCE=DeleteReport.cs DeleteReportDlg.cs

set RESOURCES=DeleteReportDlg.resx

set COMPILED_RESOURCES=/res:DeleteReportDlg.resources,DeleteReport.DeleteReportDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile DeleteReportDlg.resx
