...
set SOURCE=ViewPackagesAndReports.cs ViewAllDlg.cs

set RESOURCES=ViewAllDlg.resx

set COMPILED_RESOURCES=/res:ViewAllDlg.resources,ViewAll.ViewAllDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile ViewAllDlg.resx
csc /nologo /t:winexe /out:ViewAll.exe %COGDLLS% /r:SamplesCommon.dll %SOURCE% %ICON% %COMPILED_RESOURCES%
