...
{
	/// <summary>
	/// Summary description for ViewAllDlg.
	/// </summary>
	public class ViewAllDlg : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ViewAllDlg));
            ...
            this.serverUrlTB.Location = new System.Drawing.Point(166, 16);
            this.serverUrlTB.Name = "serverUrlTB";
            this.serverUrlTB.Size = new System.Drawing.Size(482, 20);
            ...
            this.groupBox1.Size = new System.Drawing.Size(632, 256);
            ...
            this.resultsDisplayWindowRTB.Size = new System.Drawing.Size(616, 232);
            this.resultsDisplayWindowRTB.TabIndex = 0;
            this.resultsDisplayWindowRTB.Text = "";
            // 
            // viewAllButton
            // 
            this.viewAllButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.viewAllButton.Location = new System.Drawing.Point(560, 48);
            this.viewAllButton.Name = "viewAllButton";
            this.viewAllButton.Size = new System.Drawing.Size(88, 32);
            ...
            this.Name = "ViewAllDlg";
            this.Text = "ViewAllDlg";
		...
		private void menuItemAbout_Click(object sender, System.EventArgs e)
		{
			...
			about.applicationName = "ViewAll Sample";
		...
		private void viewAllButton_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				ViewAll viewAllObj = new ViewAll();
				displayMessage("Sending queries...");
				viewAllObj.doViewAll(cBIServer, ref resultMessage);
			...
			catch(System.Exception ex)
			{
				...
				{
					SamplesException.ShowExceptionMessage( ex.Message, true, "ViewAll Sample" );					
				}
				return;
			}
		}
