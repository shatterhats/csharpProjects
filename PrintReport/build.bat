...
set SOURCE=PrintReport.cs PrintReportDlg.cs

set RESOURCES=PrintReportDlg.resx

set COMPILED_RESOURCES=/res:PrintReportDlg.resources,PrintReport.PrintReportDlg.resources

set COGDLLS=/r:cognosdotnet_10_2.dll /r:cognosdotnetassembly_10_2.dll

resgen /compile PrintReportDlg.resx
